...
function AnimatedSlider() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AnimatedSlider.useEffect": ()=>{
            ...
            const raf = {
                "AnimatedSlider.useEffect.raf": (time)=>{
                    lenis.raf(time);
                    requestAnimationFrame(raf);
                }
            }["AnimatedSlider.useEffect.raf"];
            requestAnimationFrame(raf);
            // Animate each slide when it comes into view
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.toArray(".slide").forEach({
                "AnimatedSlider.useEffect": (slide, index)=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].fromTo(slide.querySelector(".slide-content"), {
                        y: 100,
                        opacity: 0
                    }, {
                        y: 0,
...
_s(AnimatedSlider, "8puyVO4ts1RhCfXUmci3vLI3Njw=");
_c = AnimatedSlider;
var _c;
...
//# sourceMappingURL=src_609be638._.js.map