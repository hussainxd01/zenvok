...
export default function HeroComponent() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // scale ZENVOK down on scroll, back up when returning
  ...
  return (
    <div ref={outerDivRef} className="relative overflow-hidden">
      ...
      <div
        ref={loaderRef}
        className="fixed inset-0 z-[99999] flex items-center justify-center pointer-events-none px-4"
        style={{ backgroundColor: "#05101f" }}
      >
        <div className="tracking-tight flex flex-wrap justify-center gap-2 text-lg sm:text-3xl md:text-4xl font-medium text-center text-white">
      ...
      >
        ...
        <div className="absolute top-1/3 right-6 sm:right-12 md:right-16 max-w-[260px] sm:max-w-xs md:max-w-sm text-left z-10">
          <p className="text-white/90 text-sm sm:text-base md:text-lg leading-snug font-light">
            ...
            <br />
            Turning digital visions
            <br />
            into industry-leading experiences.
          </p>
        </div>
        ...
        <div className="absolute bottom-6 right-6 sm:bottom-10 sm:right-10 z-10">
          <div
            ref={arrowRef}
            className="p-4 cursor-pointer hover:opacity-70 transition-opacity"
          >
